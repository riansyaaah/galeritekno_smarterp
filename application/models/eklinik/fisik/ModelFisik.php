...
class ModelFisik extends CI_Model
{
  public $table = 'ekl_pasienfisik as fisik';
  ...
  public function getFisik()
  {
    ...
    $this->db->join('ekl_regpasien reg', 'reg.nomorregistrasi=fisik.noregistrasi', 'left');
  ...
  {
    $this->db->select('reg.norm, reg.nomorregistrasi, reg.nik, reg.nama, reg.tempatlahir, reg.tanggallahir, reg.jeniskelamin,reg.alamat,reg.umur, fisik.*');
    $this->db->join('ekl_regpasien reg', 'reg.nomorregistrasi=fisik.noregistrasi', 'left');
