...
class ModelPremedcheck extends CI_Model
{
  public $table = 'ekl_pasienpremedcheck as premedcheck';
  public $id = 'fisik.noregistrasi';
  public $order = 'DESC';
  ...
  public function getPremedcheck()
  {
    ...
    $this->db->join('ekl_regpasien reg', 'reg.nomorregistrasi=premedcheck.noregistrasi', 'left');
  ...
  {
    $this->db->select('reg.norm, reg.nomorregistrasi, reg.nik, reg.nama, reg.tempatlahir, reg.tanggallahir, reg.jeniskelamin,reg.alamat,reg.umur, premedcheck.*');
    $this->db->join('ekl_regpasien reg', 'reg.nomorregistrasi=premedcheck.noregistrasi', 'left');
