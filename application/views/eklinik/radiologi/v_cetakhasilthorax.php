      ...
      <div style="width:50%;float:left;">
		...
		<div style="width:100%; float:left;">
			<table class="nilai1" style="border: 0;"> 
				...
				<tr>
					<td width="30%" valign="top"><b>Hasil Pemeriksaan</b></td>
					<td width="2%" valign="top">:</td>
				</tr>
                <br>
				<br>
                <tr>
					<td width="30%" valign="top">C O R</td>
					<td width="2%" valign="top">:</td>
					<td width="50%" valign="top"><?php echo $cor;?></td>
				</tr>
				<br>
				<br>
				<tr>
					...
					<td valign="top" >:</td>
					<td valign="top" ><?php echo $pulmo;?></td>
				</tr>
				<br>
				<br>
				<tr>
					<td valign="top" >Sinus dan Diafragma</td>
					<td valign="top" >:</td>
					<td valign="top" ><?php echo $sinusdiafragma;?></td>
				</tr>
				<br>
				<br>
				<tr>
					<td valign="top" >Tulang dan Jaringan Lunak</td>
					<td valign="top" >:</td>
					<td valign="top" ><?php echo $tulangjaringanlunak;?></td>
				</tr>
				<br>
				<br>
				<tr>
					<td valign="top" ><b>Kesan</b></td>
					<td valign="top" >:</td>
                ...
                <tr>
					...
					<td valign="top" >:</td>
					<td valign="top" ><?php echo $catatandokterradiologi;?></td>
				</tr>
				<br>
				<br>
                <tr>
					<td valign="top" ><b>Kesimpulan</b></td>
					<td valign="top" >:</td>
					<td valign="top" ><?php if($hasilradiologi == 'Normal'){echo "Dalam Batas Normal";}else{echo $hasilradiologi;} ?></td>
				</tr>
				<br>
			...
			<div style="width:30%; float:right;">
				<table class="nilai5">
					...
					<tr>
						<td></td>
						<td></td>
						<td style="text-align:center;"><?php echo $dokterpemeriksaradiologi;?></td>
					</tr>
				</table>
			</div>
