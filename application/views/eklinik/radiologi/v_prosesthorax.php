								...
								<div class="form-group">
									<div class="col-lg-12">
										<table width="100%" class="table table-striped table-hover">
                                            ...
                                            <tr><td><a href="<?php echo base_url();?>eklinik/radiologi/thorax/cetakhasil/<?php echo $id;?>"><button id="cetak"  type="button" class="btn btn-primary pull-left"><i class="fa fa-check"></i> Preview Hasil</button></a></td></tr>
					...
					<div class="panel">
						<div class="tab-block mb25">
							<ul class="nav nav-tabs tabs-border nav-justified">
                                <li class="active">
												<a href="#THORAXPA" data-toggle="tab">HASIL PEMERIKSAAN RADIOLOGI</a>
								</li>
                            </ul>
						</div>
						<div class="panel-body p20 pb10">
							<div class="tab-content  pn br-n admin-form">
                                <div id="THORAXPA" class="tab-pane active">
					...
					<div class="col-lg-6">
                        ...
                        <option value="Abnormal" >Abnormal</option>
                            <option value="Tidak Periksa" >Tidak Periksa</option>
                                                    ...
                                                    <div class="form-group">
					<label for="inputStandard" class="col-lg-3 control-label">File Radiologi </label>
					<div class="col-lg-6">
						<input type="file">
													...
													<div class="form-group">
					<label for="inputStandard" class="col-lg-3 control-label">COR </label>
					<div class="col-lg-9">
						<textarea class="form-control input-lg m-b" rows="5" cols="30" name="cor" id="cor">Bentuk, Ukuran Dan Letak Normal</textarea>
						
					</div>
				</div>
                                                        <div class="form-group">
					<label for="inputStandard" class="col-lg-3 control-label">Pulmo </label>
					<div class="col-lg-9">
						<textarea class="form-control input-lg m-b" rows="5" cols="30" name="pulmo" id="pulmo" >Corakan Bronchovaskular Baik tak Tampak Infiltrat maupun Spesifik Aktif, Tidak Tampak Sol</textarea>
						
					</div>
				</div>
                                                        <div class="form-group">
					<label for="inputStandard" class="col-lg-3 control-label">Sinus dan Diafragma </label>
					<div class="col-lg-9">
						<textarea class="form-control input-lg m-b" rows="5" cols="30" name="sinusdiafragma" id="sinusdiafragma">Kedua Sudut Costoprenicus Masih Tajam. Kedua Difragma Masih Licin</textarea>
						
					</div>
				</div>
                                                        <div class="form-group">
					<label for="inputStandard" class="col-lg-3 control-label">Tulang & Jaringan Lunak </label>
					<div class="col-lg-9">
						<textarea class="form-control input-lg m-b" rows="5" cols="30" name="tulangjaringanlunak" id="tulangjaringanlunak" >Intak</textarea>
						
					</div>
				</div>
                                                    
                                                    <div class="form-group">
					<label for="inputStandard" class="col-lg-3 control-label">Kesan </label>
					<div class="col-lg-9">
...
<script>
						$(document).ready(function() {
                            ...
                            $("#dokterpemeriksa").select2({
								...
								ajax: {
									url: '<?php echo base_url("eklinik/radiologi/thorax/getDokter") ?>',
									dataType: 'json',
									type: "GET",
									delay: 250,
                            ...
                            $("#petugas").select2({
								...
								ajax: {
									url: '<?php echo base_url("eklinik/radiologi/thorax/getPetugas") ?>',
									dataType: 'json',
									type: "GET",
									delay: 250,
									data: function (params) {
                        ...
                        function getData() {
							...
							$.ajax({
								url: '<?php echo base_url("eklinik/radiologi/thorax/getData") ?>',
								type: 'POST',
								dataType: 'json',
								data: dataPost,
								success: function(res) {
									...
									if (res.status_json) {
										...
										$('#cor').val(data.cor);
										$('#pulmo').val(data.pulmo);
										$('#sinusdiafragma').val(data.sinusdiafragma);
										$('#tulangjaringanlunak').val(data.tulangjaringanlunak);
            ...
            var cor = $('#cor').val();
            var pulmo = $('#pulmo').val();
            var sinusdiafragma = $('#sinusdiafragma').val();
            var tulangjaringanlunak = $('#tulangjaringanlunak').val();
			...
			if (dokterpemeriksa == "" || dokterpemeriksa == null || petugas == "" || petugas == null) {
				...
				$.ajax({
					url: '<?php echo base_url("eklinik/radiologi/thorax/proses_act") ?>',
					type: 'POST',
					dataType: 'json',
					data: dataPost,
					success: function(res) {
