        ...
        <script>
            $(document).ready(function() {
                $("#table-menu").dataTable({
                    ajax: {
                        url: '<?php echo base_url("eklinik/masterdata/getTindakan") ?>',
                        dataSrc: 'data'
                    },
                    columns: [
                        { 
            ...
            function add(status)
            {
                ...
                showLoading();
                $.ajax({
                    url: '<?= base_url("eklinik/masterdata/getTIndakan") ?>',
                    type: 'POST',
                    dataType: 'json',
                    data: dataPost,
                    success: function(res){
                        ...
                        if(res.status_json){
                            data = res.data;
                             $('#status').val('tambah');
                                document.getElementById("headermodaltambah").innerHTML = "ADD MASTER DATA TINDAKAN";
                                document.getElementById("title_kode").innerHTML = "Kode Tindakan";
                                document.getElementById("title_nama").innerHTML = "Nama TIndakan";
                             dismisLoading();
                             $("#tambahModal").modal();
                        }else{
            ...
            function saveitem()
            {
                ...
                if(kode == "" || kode == null){
                    showSnackError("Harap isi Kode Tindakan");
				}else if(nama == "" || nama == null){
                    showSnackError("Harap isi Nama Tindakan"); 
                }else{
                    btn.value = 'Loading...';
                    ...
                    $.ajax({
                        url: '<?= base_url("eklinik/masterdata/saveTindakan") ?>',
                        type: 'POST',
                        dataType: 'json',
                        data: dataPost,
                        success: function(res){
            ...
            function edit(id,status)
            {
                ...
                showLoading();
                $.ajax({
                    url: '<?= base_url("eklinik/masterdata/getTindakanbyid") ?>',
                    type: 'POST',
                    dataType: 'json',
                    data: dataPost,
                    success: function(res){
                        ...
                        if(res.status_json){
                            ...
                            $('#status').val('edit');
                                document.getElementById("headermodaltambah").innerHTML = "EDIT MASTER DATA TINDAKAN";
                                document.getElementById("title_kode").innerHTML = "Kode Tindakan";
                                document.getElementById("title_nama").innerHTML = "Nama TIndakan";
                             dismisLoading();
                             $("#tambahModal").modal();
                ...
                $.ajax({
                    ...
                    success: function(res){
                        ...
                        if(res.status_json){
                            ...
                            document.getElementById("headermodalhapus").innerHTML = "Delete Tindakan  ";
