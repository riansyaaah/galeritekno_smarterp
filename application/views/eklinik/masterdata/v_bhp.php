    ...
    <body>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-striped" id="table-bhp">
                                                <thead>
													<tr>
														<th>No.</th>
														<th>Kode</th>
        ...
        <script>
            $(document).ready(function() {
                $("#table-bhp").dataTable({
                    ajax: {
                        url: '<?php echo base_url("eklinik/masterdata/getBhp") ?>',
                        dataSrc: 'data'
                    },
                    columns: [
                        { 
			...
			function add(status){
                ...
                showLoading();
                $.ajax({
                    url: '<?= base_url("eklinik/masterdata/getBhp") ?>',
                    type: 'POST',
                    dataType: 'json',
                    data: dataPost,
                    success: function(res){
                        ...
                        if(res.status_json){
                            data = res.data;
                             $('#status').val('tambah');
                                document.getElementById("headermodaltambah").innerHTML = "ADD MASTER DATA BHP";
                                document.getElementById("title_kode").innerHTML = "Kode";
			...
			function saveitem(){
                ...
                if(kode == "" || kode == null){
                    ...
                    $.ajax({
                        url: '<?= base_url("eklinik/masterdata/saveBhp") ?>',
                        type: 'POST',
                        dataType: 'json',
                        data: dataPost,
                        success: function(res){
			...
			function edit(id,status)
            {
                ...
                showLoading();
                $.ajax({
                    url: '<?= base_url("eklinik/masterdata/getBhpbyid") ?>',
                    type: 'POST',
                    dataType: 'json',
                    data: dataPost,
                    success: function(res){
                        ...
                        if(res.status_json){
                            ...
                            $('#status').val('edit');
                                document.getElementById("headermodaltambah").innerHTML = "EDIT MASTER DATA BHP";
                                document.getElementById("title_kode").innerHTML = "Kode";
                                document.getElementById("title_nama").innerHTML = "Nama";
                                document.getElementById("title_satuan").innerHTML = "Satuan";
                             dismisLoading();
                ...
                $.ajax({
                    ...
                    success: function(res){
                        ...
                        if(res.status_json){
                            ...
                            document.getElementById("headermodalhapus").innerHTML = "Delete Bhp  ";
            ...
            function itemHapus()
            {
                ...
                var code_hapus = $('#code_hapus').val();
                    ...
                    $.ajax({
                        url: '<?= base_url("eklinik/masterdata/deleteBhp") ?>',
                        type: 'POST',
                        dataType: 'json',
                        data: dataPost,
                        success: function(res){
