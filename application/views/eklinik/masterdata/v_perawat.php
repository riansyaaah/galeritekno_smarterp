        ...
        <script>
            $(document).ready(function() {
                $("#table-menu").dataTable({
                    ajax: {
                        url: '<?php echo base_url("eklinik/masterdata/getPerawat") ?>',
                        dataSrc: 'data'
                    },
                    columns: [
                        { 
            ...
            function add(status){
                ...
                showLoading();
                $.ajax({
                    url: '<?= base_url("eklinik/masterdata/getPerawat") ?>',
                    type: 'POST',
                    dataType: 'json',
                    data: dataPost,
                    success: function(res){
                        ...
                        if(res.status_json){
                            data = res.data;
                             $('#status').val('tambah');
                                document.getElementById("headermodaltambah").innerHTML = "ADD MASTER DATA PERAWAT";
                                document.getElementById("title_nama").innerHTML = "Nama Perawat";
            ...
            function saveitem()
            {
                ...
                if(nama == "" || nama == null){
                    ...
                    $.ajax({
                        url: '<?= base_url("eklinik/masterdata/savePerawat") ?>',
                        type: 'POST',
                        dataType: 'json',
                        data: dataPost,
                        success: function(res){
            ...
            function edit(id,status)
            {
                ...
                showLoading();
                $.ajax({
                    url: '<?= base_url("eklinik/masterdata/getPerawatbyid") ?>',
                    type: 'POST',
                    dataType: 'json',
                    data: dataPost,
                    success: function(res){
                        ...
                        if(res.status_json){
                            ...
                            $('#status').val('edit');
                                document.getElementById("headermodaltambah").innerHTML = "EDIT MASTER DATA PERAWAT";
                                document.getElementById("title_nama").innerHTML = "Nama Perawat";
                                document.getElementById("title_email").innerHTML = "Email";
                                document.getElementById("title_nohp").innerHTML = "No Telepon";
                                document.getElementById("title_alamat").innerHTML = "Alamat";
                ...
                $.ajax({
                    ...
                    success: function(res){
                        ...
                        if(res.status_json){
                            ...
                            document.getElementById("headermodalhapus").innerHTML = "Delete Perawat  ";
            ...
            function itemHapus()
            {
                ...
                var code_hapus = $('#code_hapus').val();
                    ...
                    $.ajax({
                        url: '<?= base_url("eklinik/masterdata/deletePerawat") ?>',
                        type: 'POST',
                        dataType: 'json',
                        data: dataPost,
                        success: function(res){
