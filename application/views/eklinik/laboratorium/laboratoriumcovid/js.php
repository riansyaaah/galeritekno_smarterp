...
<script src="<?= base_url('application/views/eklinik/laboratorium/laboratoriumcovid/domElement.js'); ?>"></script>
<script src="<?= base_url('application/views/eklinik/laboratorium/laboratoriumcovid/domDatatable.js'); ?>"></script>
<script src="<?= base_url('application/views/eklinik/laboratorium/laboratoriumcovid/domInputData.js'); ?>"></script>
<script src="<?= base_url('application/views/eklinik/laboratorium/laboratoriumcovid/domRender.js'); ?>"></script>
<script src="<?= base_url('application/views/eklinik/laboratorium/laboratoriumcovid/domRouting.js'); ?>"></script>