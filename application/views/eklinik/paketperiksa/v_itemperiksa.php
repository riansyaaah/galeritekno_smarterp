    ...
    <body>
        ...
        <?php foreach($getitem as $g){?>
            ...
            <td>
                ...
                <a href="#" class="edit_record btn btn-danger btn-sm" onclick="deleteItem('<?=$g['id'];?>')">- Delete</a>
                       <?php } ?>
                <a href="<?php echo base_url();?>eklinik/paketperiksa/itemperiksa/detailtariflab/<?php echo $g['id'];?>" target="_blank" class="edit_record btn btn-warning btn-sm">Detail Tarif</a>
                </td>
                <?php }else{ ?>
                <td>
                
                <a href="<?php echo base_url();?>eklinik/paketperiksa/itemperiksa/detailtarifpenunjang/<?php echo $g['id'];?>" target="_blank" class="edit_record btn btn-warning btn-sm">Detail Tarif</a>
                </td>
                <?php } ?>
            </tr>
            <?php } ?>
         ...
         <script type="text/javascript">
            ...
            $(document).ready(function() {
             ...
             function tambahItem(id_paren,level){
                ...
                showLoading();
                $.ajax({
                    url: '<?php echo base_url("eklinik/paketperiksa/itemperiksa/getItem") ?>',
                    type: 'POST',
                    dataType: 'json',
                    data: dataPost,
             ...
             function itemBaru(){
                ...
                if(nama_item == "" || nama_item == null){
                    ...
                    $.ajax({
                        url: '<?php echo base_url("eklinik/paketperiksa/itemperiksa/addItem") ?>',
                        type: 'POST',
                        dataType: 'json',
                        data: dataPost,
                        success: function(res){
             ...
             function itemEdit(){
                ...
                if(nama_item == "" || nama_item == null){
                    ...
                    $.ajax({
                        url: '<?php echo base_url("eklinik/paketperiksa/itemperiksa/editItem") ?>',
                        type: 'POST',
                        dataType: 'json',
                        data: dataPost,
                        success: function(res){
             ...
             function itemhapus(){
                ...
                var id_item = $('#id_item').val();
                    ...
                    $.ajax({
                        url: '<?php echo base_url("eklinik/paketperiksa/itemperiksa/deleteItem") ?>',
                        type: 'POST',
                        dataType: 'json',
                        data: dataPost,
                        success: function(res){
