...
<body>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="invoice-title">
                                                ...
                                                <h2 style="text-align:center;">BALANCE SHEET REPORT</h2>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-4">
                                        <div class="col-md-6">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-hover table-md" id="table_preview1">
                                                    <thead>
                                                        <tr>
                                                            <th class="text-center">ASSETS </th>
                                                            <th class="text-center">JAN-2021 </th>
                                                            <th class="text-center">JAN-2020</th>
                                                        </tr>
                                                    </thead>
                                                </table>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-hover table-md" id="table_preview2">
                                                    <thead>
                                                        <tr>
                                                            <th class="text-center">LIABITIES & EQUITY </th>
                                                            <th class="text-center">JAN-2021 </th>
                                                            <th class="text-center">JAN-2020</th>
                                                        </tr>
                                                    </thead>
    ...
    <script>
        document.querySelector('#btn_cetak').addEventListener('click', e => {
            ...
            document.querySelector('#print').innerHTML = `<a hidden href="<?= base_url('finance/reports/balancesheet/cetak') ?>?year=${year}&month=${month}" id="btn_print" target="_blank"></a>`;
        ...
        function Preview(){
            ...
            showLoading();
            $("#table_preview1").dataTable({
                ajax: {
                    url: '<?php echo base_url("finance/reports/balancesheet/getData1") ?>',
                    dataSrc: 'data',
                    type: 'POST',
                    dataType: 'json',
                    data: dataPost,
            ...
            $("#table_preview2").dataTable({
                ajax: {
                    url: '<?php echo base_url("finance/reports/balancesheet/getData2") ?>',
                    dataSrc: 'data',
                    type: 'POST',
                    dataType: 'json',
                    data: dataPost,
