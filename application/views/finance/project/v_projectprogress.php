...
<body>
	...
	<div id="app">
								...
								<div class="card-body">
									<div class="row">
										<div class="col-md-12">
												...
												<div class="col-md-3">
													<div class="input-group mb-2">
														...
														<div class="input-group-append">
															<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#ClientId"
																>...</button>
														</div>
													</div>
												</div>
                                            ...
                                            <div class="form-group row">
												<label class="col-md-3">No Kontrak</label>
												<div class="col-md-8">
													<input type="text" name="no_kontrak" class="form-control" readonly>
												</div>
											</div>
                                            <div class="form-group row">
												<label class="col-md-3">Mulai</label>
												<div class="col-md-3">
													<input type="date" name="mulai" class="form-control" readonly>
												</div>
                                                <label class="col-md-2">SD</label>
                                                <div class="col-md-3">
													<input type="date" name="sd" class="form-control" readonly>
												</div>
											</div>
                                            <div class="form-group row">
												<label class="col-md-3">Total Nilai Project</label>
												<div class="col-md-5">
													<input type="text" name="usd" class="form-control" placeholder="USD"
														readonly>
													<input type="text" name="idr" class="form-control" placeholder="IDR"
														readonly>
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3">Progress (%)</label>
												<div class="col-md-4">
                                            ...
                                            <div class="form-group row">
												...
												<div class="col-md-1">
													<input type="checkbox" name="cancel" class="form-control">
												</div>
											</div>
											<div class="form-group row">
                                                <div class="col-md-9">
                                                    <button type="submit" class="btn-sm btn-primary" disabled>Item Entire</button>
                                                </div>
												<div class="col-md-3">
		...
		<div class="modal fade" id="ClientId" role="dialog" aria-hidden="true">
								...
								<div class="form-group row">
									...
									<div class="col-md-3">
										<div class="input-group mb-2">
											...
											<div class="input-group-append">
												<a href="#" class="edit_record btn btn-primary btn-sm" onclick="cariCustomer()">...</a>    
                                            </div>    
										</div>
									</div>
                                    <div class="col-md-6">
		...
		<script>
            ...
            function cariCustomer() 
			{
				...
				$("#table-menu").dataTable({
					ajax: {
						url: '<?= base_url("finance/project/praproject/getCustomer") ?>',
						dataSrc: 'data'
					},
					columns: [{
							"data": 'ClientID',
