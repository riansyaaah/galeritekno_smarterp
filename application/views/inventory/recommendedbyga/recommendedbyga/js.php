...
<script src="<?= base_url('application/views/inventory/recommendedbyga/recommendedbyga/domRender.js') ?>"></script>
<script src="<?= base_url('application/views/inventory/recommendedbyga/recommendedbyga/domElement.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/recommendedbyga/recommendedbyga/domDatatable.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/recommendedbyga/recommendedbyga/domInputData.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/recommendedbyga/recommendedbyga/domRouting.js'); ?>"></script>