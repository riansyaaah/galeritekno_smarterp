...
<script src="<?= base_url('application/views/inventory/masterdata/itemmaster/domRender.js') ?>"></script>
<script src="<?= base_url('application/views/inventory/masterdata/itemmaster/domElement.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/masterdata/itemmaster/domDatatable.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/masterdata/itemmaster/domInputData.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/masterdata/itemmaster/domRouting.js'); ?>"></script>