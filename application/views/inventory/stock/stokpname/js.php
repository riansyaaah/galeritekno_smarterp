...
<script src="<?= base_url('application/views/inventory/stock/stokpname/domRender.js') ?>"></script>
<script src="<?= base_url('application/views/inventory/stock/stokpname/domElement.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/stock/stokpname/domDatatable.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/stock/stokpname/domInputData.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/stock/stokpname/domRouting.js'); ?>"></script>