...
<script src="<?= base_url('application/views/inventory/stock/historystokopname/domElement.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/stock/historystokopname/domDatatable.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/stock/historystokopname/domInputData.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/stock/historystokopname/domRender.js') ?>"></script>
<script src="<?= base_url('application/views/inventory/stock/historystokopname/domRouting.js'); ?>"></script>