<html>
    ...
    <section>
        ...
        <table class="fullWidth" cellpadding="3">
            <tr>
                <th class="fwBold text-center border" style="width: 7%;">No</th>
                <th class="fwBold text-center border" style="width: 43%;">Nama Item</th>
                <th class="fwBold text-center border" style="width: 15%;">Unit</th>
                <th class="fwBold text-center border" style="width: 15%;">Jumlah</th>
                <th class="fwBold text-center border" style="width: 20%;">Harga Satuan</th>
            </tr>
        ...
        <table class="fullWidth">
            <tr>
                <td class="border">Total Harga dalam Huruf :<br><br><br><?= $data['terbilang']; ?></td>
                <td>
                    <table>
                        <tr>
                            <td>Mata Uang</td>
