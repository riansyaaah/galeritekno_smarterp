...
<script src="<?= base_url('application/views/inventory/purchasing/listpo/domRender.js') ?>"></script>
<script src="<?= base_url('application/views/inventory/purchasing/listpo/domElement.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/purchasing/listpo/domDatatable.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/purchasing/listpo/domInputData.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/purchasing/listpo/domRouting.js'); ?>"></script>