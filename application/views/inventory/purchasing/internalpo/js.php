...
<script src="<?= base_url('application/views/inventory/purchasing/internalpo/domRender.js') ?>"></script>
<script src="<?= base_url('application/views/inventory/purchasing/internalpo/domElement.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/purchasing/internalpo/domDatatable.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/purchasing/internalpo/domInputData.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/purchasing/internalpo/domRouting.js'); ?>"></script>