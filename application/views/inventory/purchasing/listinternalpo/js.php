...
<script src="<?= base_url('application/views/inventory/purchasing/listinternalpo/domRender.js') ?>"></script>
<script src="<?= base_url('application/views/inventory/purchasing/listinternalpo/domElement.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/purchasing/listinternalpo/domDatatable.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/purchasing/listinternalpo/domInputData.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/purchasing/listinternalpo/domRouting.js'); ?>"></script>