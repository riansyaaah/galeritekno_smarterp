...
<script src="<?= base_url('application/views/inventory/transaction/stockin/domRender.js') ?>"></script>
<script src="<?= base_url('application/views/inventory/transaction/stockin/domElement.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/transaction/stockin/domDatatable.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/transaction/stockin/domInputData.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/transaction/stockin/domRouting.js'); ?>"></script>