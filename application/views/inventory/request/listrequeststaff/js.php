...
<script src="<?= base_url('application/views/inventory/request/listrequeststaff/domRender.js') ?>"></script>
<script src="<?= base_url('application/views/inventory/request/listrequeststaff/domElement.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/request/listrequeststaff/domDatatable.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/request/listrequeststaff/domInputData.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/request/listrequeststaff/domRouting.js'); ?>"></script>