...
<script src="<?= base_url('application/views/inventory/request/swaberrequest/domRender.js') ?>"></script>
<script src="<?= base_url('application/views/inventory/request/swaberrequest/domElement.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/request/swaberrequest/domDatatable.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/request/swaberrequest/domInputData.js'); ?>"></script>
<script src="<?= base_url('application/views/inventory/request/swaberrequest/domRouting.js'); ?>"></script>