		...
		<script>
			$(document).ready(function() {
				$("#table-menu").dataTable({
					ajax: {
						url: '<?php echo base_url("hrm/master/departments/getDepartment") ?>',
						dataSrc: 'data'
					},
					columns: [{
						"data": 'no',
			...
			function edit(id, status) {
				...
				showLoading();
				$.ajax({
					url: '<?php echo base_url("hrm/master/departments/getDepartmentbyid") ?>',
					type: 'POST',
					dataType: 'json',
					data: dataPost,
					success: function(res) {
			...
			function save() {
				...
				if (department == "" || department == null) {
					...
					$.ajax({
						url: '<?php echo base_url("hrm/master/departments/saveDepartment") ?>',
						type: 'POST',
						dataType: 'json',
						data: dataPost,
						success: function(res) {
			...
			function itemHapus() {
				...
				$.ajax({
					url: '<?php echo base_url("hrm/master/departments/deleteDepartment") ?>',
					type: 'POST',
					dataType: 'json',
					data: dataPost,
					success: function(res) {
