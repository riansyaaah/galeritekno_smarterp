...
<body>
	...
	<div id="app">
						...
						<div class="col-12">
							<div class="card">
								...
								<div class="card-body">
									...
									<button type="button" class="btn  btn-primary btn-sm mb-2" id="btn_add_leave" onclick="add()"><i class="fa fa-plus"></i> Add Leave</button>
									<div class="table-responsive">
										<table class="table table-hover table-bordered" id="table-detail-leave" style="width: 100%;">
											<thead>
												<tr>
													<th>No</th>
													<th>Staff</th>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<input type="date" class="form-control form-control-sm" id="end_date" required="">
						</div>
						<div class="form-group">
		...
		<script>
			...
			function loadData() {
				$("#table-detail-leave").dataTable({
					destroy: true,
					ajax: {
						url: '<?php echo base_url("hrm/form/Leaves/getLeaves") ?>',
						dataSrc: 'data'
					},
					columns: [{
						"data": 'no',
			...
			function cariPeriode() {
				...
				$('#table-periode tbody').on('click', 'tr', function() {
					...
					document.getElementById("btn_add_leave").disabled = false;

					LeaveCari();
					$('#cariPeriode').modal('hide');
					// flash Table
					$('#table-detail-leave').DataTable().clear().draw();
					$('#table-detail-leave').DataTable().destroy();
				});
			}
			...
			function add() {
				...
				document.getElementById("headerModal").innerHTML = "ADD LEAVE";
			...
			function edit(id, status) {
				...
				showLoading();
				$.ajax({
					url: '<?php echo base_url("hrm/form/Leaves/getLeaveById") ?>',
					type: 'POST',
					dataType: 'json',
					data: dataPost,
					success: function(res) {
						...
						if (res.status_json) {
							...
							$("#end_date").removeClass("is-invalid");
							$("#description").removeClass("is-invalid");
							document.getElementById("headerModal").innerHTML = "EDIT LEAVE";
							document.getElementById("title_start_date").innerHTML = "Start Date";
			...
			function save() {
				...
				if (start_date == "" || start_date == null || staff_name == "" || staff_name == null || end_date == "" || end_date == null || description == "" || description == null) {
					...
					$.ajax({
						url: '<?php echo base_url("hrm/form/Leaves/saveLeave") ?>',
						type: 'POST',
						dataType: 'json',
						data: dataPost,
						success: function(res) {
				...
				$.ajax({
					...
					success: function(res) {
						...
						if (res.status_json) {
							...
							document.getElementById("headerModalDelete").innerHTML = "Delete Leave ";
			...
			function itemHapus() {
				...
				$.ajax({
					url: '<?php echo base_url("hrm/form/Leaves/deleteLeave") ?>',
					type: 'POST',
					dataType: 'json',
					data: dataPost,
					success: function(res) {
				...
				$.ajax({
					...
					success: function(res) {
						...
						if (res.status_json) {
							...
							document.getElementById("headerModalApprove").innerHTML = "APPROVE LEAVE ";
			...
			function itemApprove() {
				...
				$.ajax({
					url: '<?php echo base_url("hrm/form/Leaves/approveLeave") ?>',
					type: 'POST',
					dataType: 'json',
					data: dataPost,
					success: function(res) {
				...
				$.ajax({
					...
					success: function(res) {
						...
						if (res.status_json) {
							...
							document.getElementById("headerModalAbort").innerHTML = "ABORT LEAVE ";
			...
			function itemAbort() {
				...
				$.ajax({
					url: '<?php echo base_url("hrm/form/Leaves/abortLeave") ?>',
					type: 'POST',
					dataType: 'json',
					data: dataPost,
					success: function(res) {
			...
			function LeaveCari() {
				...
				$("#table-detail-leave").dataTable({
					...
					destroy: true,
					ajax: {
						url: '<?= base_url("hrm/form/leaves/getLeaveByPeriodId") ?>',
						dataSrc: 'data',
						type: 'POST',
						dataType: 'json',
						data: dataPost,
