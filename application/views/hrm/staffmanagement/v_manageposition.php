		...
		<script>
			$(document).ready(function() {
				$("#table-menu").dataTable({
					ajax: {
						url: '<?php echo base_url("hrm/staffmanagement/manageposition/getManagePosition") ?>',
						dataSrc: 'data'
					},
					columns: [{
							"data": 'no',
			...
			function edit(id, status) {
				...
				showLoading();
				$.ajax({
					url: '<?php echo base_url("hrm/staffmanagement/manageposition/getManagePositionbyid") ?>',
					type: 'POST',
					dataType: 'json',
					data: dataPost,
					success: function(res) {
			...
			function save() {
				...
				if (position == "" || position == null) {
					...
					$.ajax({
						url: '<?php echo base_url("hrm/staffmanagement/manageposition/saveManagePosition") ?>',
						type: 'POST',
						dataType: 'json',
						data: dataPost,
						success: function(res) {
			...
			function itemHapus() {
				...
				$.ajax({
					url: '<?php echo base_url("hrm/staffmanagement/manageposition/deleteManagePosition") ?>',
					type: 'POST',
					dataType: 'json',
					data: dataPost,
					success: function(res) {
