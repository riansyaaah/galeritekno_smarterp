                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                              aria-controls="home" aria-selected="true">Basic Sallary</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                              aria-controls="profile" aria-selected="false">Allowances </a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab"
                              aria-controls="contact" aria-selected="false">Commission</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab"
                              aria-controls="contact" aria-selected="false">Loan </a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab"
                              aria-controls="contact" aria-selected="false">Statutory Deduction</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab"
                              aria-controls="contact" aria-selected="false">Other Payment</a>
                          </li>
            ...
            $(document).ready(function() {
                ...
                $("#shift_id").select2({
                    ...
                    ajax: {
                        ...
                        processResults: function (res, params) {
                            var result = res.data.map(function (item) {
                                return {id: item.id, text: item.shift};
                            });
                            return {
                                results: result
                            };
                ...
                $("#designation_id").select2({
                    ...
                    ajax: {
                        ...
                        processResults: function (res, params) {
                            var result = res.data.map(function (item) {
                                return {id: item.id, text: item.designation};
                            });
                            return {
                                results: result
                            };
                ...
                $("#position_id").select2({
                    ...
                    ajax: {
                        ...
                        processResults: function (res, params) {
                            var result = res.data.map(function (item) {
                                return {id: item.id, text: item.position };
                            });
                            return {
                                results: result
                            };
                ...
                $("#departement_id").select2({
                    ...
                    ajax: {
                        ...
                        processResults: function (res, params) {
                            var result = res.data.map(function (item) {
                                return {id: item.id, text: item.departement };
                            });
                            return {
                                results: result
                            };
