...
<script src="<?= base_url('application/views/hrm/staffmanagement/shifting/domElement.js'); ?>"></script>
<script src="<?= base_url('application/views/hrm/staffmanagement/shifting/domDatatable.js'); ?>"></script>
<script src="<?= base_url('application/views/hrm/staffmanagement/shifting/domRender.js'); ?>"></script>
<script src="<?= base_url('application/views/hrm/staffmanagement/shifting/domInputData.js'); ?>"></script>
<script src="<?= base_url('application/views/hrm/staffmanagement/shifting/domRouting.js'); ?>"></script>