...
<script src="<?= base_url('application/views/hrm/staffmanagement/staffprofile/domElement.js'); ?>"></script>
<script src="<?= base_url('application/views/hrm/staffmanagement/staffprofile/domDatatable.js'); ?>"></script>
<script src="<?= base_url('application/views/hrm/staffmanagement/staffprofile/domRender.js'); ?>"></script>
<script src="<?= base_url('application/views/hrm/staffmanagement/staffprofile/domInputData.js'); ?>"></script>
<script src="<?= base_url('application/views/hrm/staffmanagement/staffprofile/domRouting.js'); ?>"></script>