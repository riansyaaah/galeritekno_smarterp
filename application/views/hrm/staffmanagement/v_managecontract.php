		...
		<script>
			$(document).ready(function() {
				$("#table-menu").dataTable({
					ajax: {
						url: '<?php echo base_url("hrm/staffmanagement/managecontract/getManageContract") ?>',
						dataSrc: 'data'
					},
					columns: [{
						"data": 'no',
			...
			function edit(id, status) {
				...
				showLoading();
				$.ajax({
					url: '<?php echo base_url("hrm/staffmanagement/Managecontract/getManageContractbyid") ?>',
					type: 'POST',
					dataType: 'json',
					data: dataPost,
					success: function(res) {
			...
			function save() {
				...
				if (duration == "" || duration == null || days == "" || days == null || description == "" || description == null) {
					...
					$.ajax({
						url: '<?php echo base_url("hrm/staffmanagement/managecontract/saveManageContract") ?>',
						type: 'POST',
						dataType: 'json',
						data: dataPost,
						success: function(res) {
			...
			function itemHapus() {
				...
				$.ajax({
					url: '<?php echo base_url("hrm/staffmanagement/managecontract/deleteManageContract") ?>',
					type: 'POST',
					dataType: 'json',
					data: dataPost,
					success: function(res) {
