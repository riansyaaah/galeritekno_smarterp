        ...
        <script>
            $(document).ready(function() {
                $("#table-menu").dataTable({
                    ajax: {
                        url: '<?php echo base_url("hrm/staffmanagement/Manageallowance/getManageAllowance") ?>',
                        dataSrc: 'data'
                    },
                    columns: [{
                        "data": 'no',
            ...
            function edit(id, status) {
                ...
                showLoading();
                $.ajax({
                    url: '<?php echo base_url("hrm/staffmanagement/Manageallowance/getManageAllowanceById") ?>',
                    type: 'POST',
                    dataType: 'json',
                    data: dataPost,
                    success: function(res) {
            ...
            function save() {
                ...
                if (allowance_name == "" || allowance_name == null || amount == "" || amount == null || set_date == "" || set_date == null || description == "" || description == null) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url("hrm/staffmanagement/manageallowance/saveManageAllowance") ?>',
                        type: 'POST',
                        dataType: 'json',
                        data: dataPost,
                        success: function(res) {
            ...
            function itemHapus() {
                ...
                $.ajax({
                    url: '<?php echo base_url("hrm/staffmanagement/manageallowance/deleteManageAllowance") ?>',
                    type: 'POST',
                    dataType: 'json',
                    data: dataPost,
                    success: function(res) {
